<script src="../../controller/super_admin/controller_courier_all.js"></script>
						...
						<div class="d-lg-flex align-items-center mb-4 gap-3">
							...
							<div class="col-md-2"> 
								<select class="form-select" id="search" aria-label="Default select example">
										...
										<option value="kurir_name">Name</option>
										<option value="kurir_vehicle_number">Vehicle Number</option>
								</select> 
							</div> 
							...
							<div class="col-md-2 ms-auto">
							  	<a onclick="page('courier_add_all.php')" class="btn btn-success radius-1 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add courier</a>
							</div>
