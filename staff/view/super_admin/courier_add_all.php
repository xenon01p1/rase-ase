<script src="../../controller/super_admin/controller_courier_add_all.js"></script>
	...
	<input type="hidden" name="detail" id="detail" value="<?= (isset($_GET['detail'])) ? $_GET['detail'] : '' ?>">
				    ...
				    <div class="card-body">
						...
						<div class="d-lg-flex align-items-center mb-1 gap-3">
						  ...
						  <div class="ms-auto">
						  	<a onclick="page('courier_all.php')" class="btn btn-primary radius-1 mt-2 mt-lg-0"><i class='bx bx-group'></i>Back</a> &nbsp;
						  </div>
						</div>
