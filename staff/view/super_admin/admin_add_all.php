<script src="../../controller/super_admin/controller_admin_add_all.js"></script>
				    ...
				    <div class="card-body">
				    	...
				    	<div class="d-lg-flex align-items-center mb-4 gap-3">
							...
							<div class="col-md-2 ms-auto">
							  	<a onclick="page('admin_add_all.php')" class="btn btn-success radius-1 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add admin</a>
							</div> 
						...
						<div class="d-lg-flex align-items-center mb-1 gap-3">
						  ...
						  <div class="ms-auto">
						  	<a onclick="page('admin_all.php')" class="btn btn-primary radius-1 mt-2 mt-lg-0"><i class='bx bx-group'></i>Back</a> &nbsp;
						  </div>
						</div>
