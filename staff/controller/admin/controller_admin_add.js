$(function(){ 
    ...
    $('#form_admin').submit(function(e){
        ...
        if (insert){
            url = "../../model/admin/model_admin_add.php?action=insert";
        }else{
            url = "../../model/admin/model_admin_add.php?action=update&admin_id="+admin_id;
        }
        console.log(url);
...
function edit_assign_value(id, detail){
    $.ajax({
        url: "../../model/admin/model_admin_add.php?action=get_data&id=" + id,
        type: "GET",
        dataType: "json", 
        success: function(data) {
            console.log(data);
